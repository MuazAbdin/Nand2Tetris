...
TEXT_COMPARER = "/Users/Muadz/Downloads/HUJI/2020_21_sem_A/Nand2Tetris/nand2tetris/tools/TextComparer.sh"
# TEXT_COMPARER = r"..\..\tools\TextComparer.bat"

# Command line to run your analyzer (without a parameter)
JACK_ANALYZER_CMD = "./JackAnalyzer"  # if JackAnalyzer - files must be in same
# directory
