...
//		quotient <<= 1
 ...
 (KLOOP)
 	...
 	D=M
 	M=M<< 	// divisor <<= 1
 	// stores the divisor value before the last shift,
 	// to use it later in case the last shift caused
 	// the divisor to become negative.
 	@posDivisor
 	M=D
 ...
 (DIVISIONLOOP)
 	...
 	// shiftright divisor
  	...
  	D=M
  	@POSITIVE
  	D,JLT 		// if the divisor is negative 
